...
class CollabFilterOneScalarPerItem(AbstractBaseCollabFilterSGD):
    ...
    def calcPred(self, user_id, item_id, mu=None):
        return (self.param_dict["b_per_user"][user_id]+
                self.param_dict["c_per_item"][item_id]+
                mu)
    ...
    def calc_loss_wrt_parameter_dict(self, param_dict, data_tuple):
        ...
        sqr_diffs_N = ag_np.square(ag_np.subtract(y_N, yhat_N))
        loss_total = ag_np.sum(sqr_diffs_N)
        return loss_total
